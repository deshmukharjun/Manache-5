...
public class Manacha4Mar extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_manacha4_mar);
        ...
        forwardButton.setOnClickListener(v -> {
            Intent intent = new Intent(Manacha4Mar.this, Manacha5Mar.class);
