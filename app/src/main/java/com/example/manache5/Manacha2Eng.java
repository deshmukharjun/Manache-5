...
public class Manacha2Eng extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_manacha2_eng);
        ...
        forwardButton.setOnClickListener(v -> {
            Intent intent = new Intent(Manacha2Eng.this, Manacha3Eng.class);
